...
def plot(data_path, leg_title, ecms, xmin, xmax, xbins, D_type):
    ...
    m_Dpi_fill(t_data, h_data, D_type)
    ...
    mbc.SaveAs('./figs/m_Dpi_'+str(ecms)+'_'+D_type+'.pdf')
...
if __name__ == '__main__':
    ...
    data_path = '/besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/anaroot/data/' + str(ecms) + '/data_' + str(ecms) + '_DstDpi_before.root'
