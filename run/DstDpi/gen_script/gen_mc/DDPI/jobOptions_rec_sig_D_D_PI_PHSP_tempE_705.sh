...
echo "./jobOptions_rec_sig_D_D_PI_PHSP_${ENERGYPOINT}.sh [NUM1] [NUM2]"
echo "[NUM1]: the minimum number range of job generated"
echo "[NUM2]: the maximum number range of job generated"

SEED=123
 
DIR_NAME_RTRAW="/besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/rtraw/mc/DDPI/$ENERGYPOINT/"
DIR_NAME_DST="/besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/dst/mc/DDPI/$ENERGYPOINT/"
mkdir -p $DIR_NAME_DST
EVENT_NO=-1

JOB_NAME="jobOptions_rec_sig_D_D_PI_PHSP_$ENERGYPOINT"
INPUT_NAME="Sig_D_D_PI_PHSP_$ENERGYPOINT"
OUTPUT_NAME="Sig_D_D_PI_PHSP_$ENERGYPOINT"
