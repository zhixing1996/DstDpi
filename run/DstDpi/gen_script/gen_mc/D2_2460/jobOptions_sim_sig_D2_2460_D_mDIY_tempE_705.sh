...
DIR_NAME="/besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/rtraw/mc/D2_2460/$ENERGYPOINT/"
mkdir -p $DIR_NAME

echo "./jobOptions_sim_sig_D2_2460_D_mDIY_${ENERGYPOINT}.sh [NUM1] [NUM2] [NUM3]"
...
JOB_NAME="jobOptions_sim_sig_D2_2460_D_mDIY"
FILE_NAME="Sig_D2_2460_D_mDIY"
...
do
    ...
    echo "EvtDecay.userDecayTableName = \"/besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/gen_script/gen_mc/decay/psi4260_D2_2460_D_mDIY.dec\";" >> $SIM_NAME
