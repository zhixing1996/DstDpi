...
echo "./jobOptions_rec_sig_D2_2460_D_mDIY_${ENERGYPOINT}.sh [NUM1] [NUM2]"
echo "[NUM1]: the minimum number range of job generated"
echo "[NUM2]: the maximum number range of job generated"

SEED=123
 
DIR_NAME_RTRAW="/besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/rtraw/mc/D2_2460/$ENERGYPOINT/"
DIR_NAME_DST="/besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/dst/mc/D2_2460/$ENERGYPOINT/"
mkdir -p $DIR_NAME_DST
EVENT_NO=-1

JOB_NAME="jobOptions_rec_sig_D2_2460_D_mDIY_$ENERGYPOINT"
INPUT_NAME="Sig_D2_2460_D_mDIY_$ENERGYPOINT"
OUTPUT_NAME="Sig_D2_2460_D_mDIY_$ENERGYPOINT"
