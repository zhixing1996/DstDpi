...
if [ "$BOSS" = "705" ]; then
    ...
    CMS=("4.626" "4.640" "4.660" "4.6812" "4.6984")
fi

COUNT=0
for ECM in ${ECMS[@]}; do
    NUM_UP=$(ls -l /besfs/groups/cal/dedx/$USER/bes/DstDpi/run/DstDpi/samples/data/$ECM | grep "txt" | wc -l)
    ...
    do
        ...
        echo "#include \"/besfs/groups/cal/dedx/\$USER/bes/DstDpi/run/DstDpi/samples/data/$ECM/$file_list\" " >> ${JobText_SaveDir}/${jobOptions}
